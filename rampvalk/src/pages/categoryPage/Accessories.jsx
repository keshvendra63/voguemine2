...
const Accessories = () => {
  ...
  return (
    ...
    <img src={modifyCloudinaryUrl(bannerState[32]?.images[0]?.url) || banner} alt={bannerState[32]?.alt} />
    </div>
    ...
    <Link to={`/collections/${collectionState[49]?.handle}`}>
      <div className="collection-card">
          ...
          <h2>{collectionState && collectionState[49]?.category}</h2>
      </div>
      </Link>
      <Link to={`/collections/${collectionState[14]?.handle}`}>
      <div className="collection-card">
          <img src={modifyCloudinaryUrl(collectionState[14]?.images[0]?.url) || "https://res.cloudinary.com/keshvendra/image/upload/v1712904161/belts_lkrnce.jpg"} alt="" />
      ...
      <div className="collection-card">
          <img src={modifyCloudinaryUrl(collectionState[46]?.images[0]?.url) || "https://res.cloudinary.com/keshvendra/image/upload/v1712904156/no_show_auziaa.jpg"} alt="" />
          <h2>{collectionState[46]?.category}</h2>
      </div></Link><Link to={`/collections/${collectionState[45]?.handle}`}>
      <div className="collection-card">
          <img src={modifyCloudinaryUrl(collectionState[45]?.images[0]?.url) || "https://res.cloudinary.com/keshvendra/image/upload/v1712904170/ankel_socks_ynk1cs.jpg"} alt="" />
          <h2>{collectionState[45]?.category}</h2>
      </div></Link><Link to={`/collections/${collectionState[44]?.handle}`}>
      <div className="collection-card">
          <img src={modifyCloudinaryUrl(collectionState[44]?.images[0]?.url) || "https://res.cloudinary.com/keshvendra/image/upload/v1712904157/low_cut_lizngm.jpg"} alt="" />
          <h2>{collectionState[44]?.category}</h2>
      </div></Link><Link to={`/collections/${collectionState[47]?.handle}`}>
      <div className="collection-card">
          <img src={modifyCloudinaryUrl(collectionState[47]?.images[0]?.url) || "https://res.cloudinary.com/keshvendra/image/upload/v1712904170/anklet_vento7.jpg"} alt="" />
          <h2>{collectionState[47]?.category}</h2>
      </div></Link><Link to={`/collections/${collectionState[48]?.handle}`}>
      <div className="collection-card">
          <img src={modifyCloudinaryUrl(collectionState[48]?.images[0]?.url) || a8} alt="" />

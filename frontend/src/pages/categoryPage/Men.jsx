    ...
    <div className='categoryPage'>
      ...
      <Link to={`/collections/${collectionState[2]?.handle}`} >
        <div className="collection-card">
            ...
            <img src={collectionState[2]?.images[0]?.url || "https://res.cloudinary.com/keshvendra/image/upload/v1712902115/shirt_qniodl.jpg"} alt="" className='col-img'/>
            <h2>{collectionState[2]?.category}</h2>
        </div>
        </Link>
        <Link to={`/collections/${collectionState[3]?.handle}`} >
        <div className="collection-card">
            <img src={collectionState[3]?.images[0]?.url || "https://res.cloudinary.com/keshvendra/image/upload/v1712902079/t_shirt_wzguwp.jpg"} alt="" />
            <h2>{collectionState[3]?.category}</h2>
        </div>
        </Link>
        <Link to={`/collections/${collectionState[43]?.handle}`} >
        <div className="collection-card">
            <img src={collectionState[43]?.images[0]?.url || "https://res.cloudinary.com/keshvendra/image/upload/v1713028400/WhatsApp_Image_2024-04-13_at_16.41.36_4da1adcf_rkwgco.jpg"} alt="" />
        ...
        <div className="collection-card">
            <img src={collectionState[0]?.images[0]?.url || "https://res.cloudinary.com/keshvendra/image/upload/v1712902105/loafers_suldb8.jpg"} alt="" />
        ...
        <div className="collection-card">
            <img src={collectionState[6]?.images[0]?.url || "https://res.cloudinary.com/keshvendra/image/upload/v1712902081/sneaker_twwejr.jpg"} alt="" />
        ...
        <div className="collection-card">
            <img src={collectionState[5]?.images[0]?.url || "https://res.cloudinary.com/keshvendra/image/upload/v1712902079/flipflop_fp4mgz.jpg"} alt="" />
            <h2>{collectionState[5]?.category}</h2>
        </div>
        </Link>
        <Link to={`/collections/${collectionState[1]?.handle}`} >
        <div className="collection-card">
            <img src={collectionState[1]?.images[0]?.url || "https://res.cloudinary.com/keshvendra/image/upload/v1712902106/jeans_dtflbu.jpg"} alt="" />
        ...
        <div className="collection-card">
            <img src={collectionState[10]?.images[0]?.url || "https://res.cloudinary.com/keshvendra/image/upload/v1712902093/shorts_cm2unp.jpg"} alt="" />
            <h2>{collectionState[10]?.category}</h2>
        </div>
        </Link>
        <Link to={`/collections/${collectionState[8]?.handle}`}>
        <div className="collection-card">
            <img src={collectionState[8]?.images[0]?.url || "https://res.cloudinary.com/keshvendra/image/upload/v1712902072/track_pant_zuxcpj.jpg"} alt="" />
